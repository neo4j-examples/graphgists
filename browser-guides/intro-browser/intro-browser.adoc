...
For an introduction to Browser's features and navigation as Neo4j's user interface, you can type `:play intro` into the command-line and press kbd:[Enter] or click the play button.

[#neo4j-feedback]
== Feedback & Questions

If you have feedback or questions on how to use Neo4j Browser, there is a small messaging system in the configuration drawer.
...
image::{img}enable_multiline_queries.jpg[width=300]
