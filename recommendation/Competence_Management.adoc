...
[[ranking]]
== Ranking candidates: a "social" approach
...
[[path]]
== Improving the ranking: path-based weighting
...
[[jaccard]]
== Improving the ranking: Jaccard similarity
...
[[competences]]
== Beyond job recommendation: a competency management tool
